...
- Pkg folder: [packages\event-inbox](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\event-inbox)
...
graph LR
  ...
  event_inbox["event_inbox"]:::center
```
...
## Usage
- Install/upgrade schema: pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package event-inbox -Apply
