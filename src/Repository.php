...
namespace BlackCat\Database\Packages\EventInbox;
...
use BlackCat\Database\Packages\EventInbox\Repository\EventInboxRepository as GeneratedRepository;
...
{
  private EventInboxRepositoryInterface $repo;
  ...
  public function __construct(private Database $db)
  {
    ...
    public function _setRepositoryForTests(RepoContract $repo): void
    {
        ...
        if (!$repo instanceof EventInboxRepositoryInterface) {
            // Allow any repo that conforms to the interface even if not generated
            throw new \InvalidArgumentException('Expected EventInboxRepositoryInterface');
        }
        $this->repo = $repo;
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\EventInbox\Dto\EventInboxDto|null { return $this->repo->getByUnique($keys, $asDto); }
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\EventInbox\Dto\EventInboxDto|null { return $this->repo->getById($id, $asDto); }
