...
namespace BlackCat\Database\Packages\EventInbox\Mapper;

use BlackCat\Database\Packages\EventInbox\Dto\EventInboxDto;
use BlackCat\Database\Packages\EventInbox\Definitions;
use DateTimeZone;
use BlackCat\Database\Support\DtoHydrator;

/**
 * Bidirectional mapper between DB rows and DTO EventInboxDto:
...
final class EventInboxDtoMapper
{
    ...
    /** @var string[] */
    private const DATE_COLS   = [ 'received_at', 'processed_at' ];
    /** @var string[] */
     ...
     * @return EventInboxDto
     */
    public static function fromRow(array $row): EventInboxDto
    {
        /** @var EventInboxDto */
    ...
    public static function fromRowOrNull(?array $row): ?EventInboxDto
    {
     ...
     *
     * @param EventInboxDto   $dto
     * @param string[]|null   $onlyProps  optional whitelist of DTO properties to serialize
     * @return array<string,mixed>
     */
    public static function toRow(EventInboxDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(EventInboxDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(EventInboxDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
     ...
     * @return array<int,EventInboxDto>
     */
    public static function hydrateList(array $rows): array
    {
        /** @var array<int,EventInboxDto> */
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(EventInboxDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,EventInboxDto>
     */
