...
final class Definitions {
    // --- core metadata ---
    public static function table(): string { return 'event_inbox'; }
    public static function contractView(): string { return 'vw_event_inbox'; }
    /** @return string[] */
    public static function columns(): array { return [ 'id', 'source', 'event_key', 'payload', 'status', 'attempts', 'last_error', 'received_at', 'processed_at' ]; }
    ...
    public static function uniqueKeys(): array { return [ [ 'source', 'event_key' ], [ 'id' ] ]; }
