...
final class EventInboxModule implements ModuleInterface
{
    public function name(): string { return 'table-event_inbox'; }
    public function table(): string { return 'event_inbox'; }
    ...
    public static function contractView(): string { return 'vw_event_inbox'; }
...
SQL;
    ...
    public function status(Database $db, SqlDialect $d): array
    {
        ...
        $expectedIdx = [ 'gin_event_inbox_payload', 'idx_event_inbox_processed', 'idx_event_inbox_status_received' ];
        if ($d->isMysql()) {
    ...
    public function info(): array
    {
        return [
            ...
            'indexes'     => [ 'gin_event_inbox_payload', 'idx_event_inbox_processed', 'idx_event_inbox_status_received' ],
            'foreignKeys' => [],
        ];
    }
}
